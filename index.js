...
const config = {
    A187: '📍🅶🅾🅻🅳🅱🅾🆃🆅2📍',
    instagram: 'https://www.instagram.com/p/CLdexvGHF7r/?igshid=3yqxo1s24h0l',
    nomer: 'wa.me/+5548999445750',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCR2ECYCJNsuJvwuEjv3EXew',
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'nulis':
           nulis(value)
               .then(data => {
                   client.sendMessage(id, '[AGUARDE UM POUCO⏳⌛', MessageType.text)
 ...
 case 'covidcountry':
           covidcountry(value)
               .then(data => {
                   ...
                   let hasil = `*País* : _${country}_ \n\n *Ativo* : _${active}_ \n *Casos por um milhão* : _${casesPerOneMillion}_ \n *Crítico* : ${critical}\n *Mortes por um milhão* : _${deathsPerOneMillion}_ \n *Recuperado* : _${recovered}_ \n *Teste por um milhão* : _${testPerOneMillion}_ \n *Casos Hoje* : _${todayCases}_ \n *Morte hoje : _${todayDeath}\n *Total de Casos* : _${totalCases}_ \n  *Teste Total* : _${totalTest}_ `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
...
case 'gay':
           gay()
               .then(data => {
                   ...
                   let hasil = `*${desc} \n\n *Porcentagem Gay Lo Su!!!* _${persen}_  `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
   ...
   case 'bitly':
    ...
    case 'bucin':
     ...
     case 'cooltext':
           ...
           break
          case 'creator':
            client.sendContact(from, '5548999445750@c.us')
            break
      case 'tts':
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[WAIT] Em andamento⏄1�71ￄ1�77 aguarde ± 1 min!', id)
